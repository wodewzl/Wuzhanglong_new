...
public class MyRedMoneyActivity extends BaseActivity {
    private String[] mTitleDataList = {"已拥有", "已使用"};
    private ViewPager mViewPager;
    private ArrayList<BaseFragment> mFragmentList;
    @Override
    public void baseSetContentView() {
        contentInflateView(R.layout.my_red_money_activity);
    }

    @Override
    public void initView() {
        mBaseTitleTv.setText("我的红包");
    ...
    private void initMagicIndicator() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setWidth(WidthHigthUtil.getScreenWidth(mActivity) / 2);
                simplePagerTitleView.setTextSize(14);
                simplePagerTitleView.setNormalColor(ContextCompat.getColor(MyRedMoneyActivity.this,R.color.C5));

                simplePagerTitleView.setSelectedColor(ContextCompat.getColor(MyRedMoneyActivity.this,R.color.colorAccent));
...
//                indicator.setYOffset(UIUtil.dip2px(context, 39));
                ...
                indicator.setColors(ContextCompat.getColor(MyRedMoneyActivity.this,R.color.colorAccent));
//                LinePagerIndicator indicator = new LinePagerIndicator(context);
