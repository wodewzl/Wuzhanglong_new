...
public class RecordRedemptionAdapter extends RecyclerBaseAdapter<HomeVO> {

    public RecordRedemptionAdapter(RecyclerView recyclerView) {
...
//        mCvCountdownView.start(995550000); // Millisecond
    ...
    public int getItemViewType(int position) {
        return R.layout.record_redemption_adapter;
    }
