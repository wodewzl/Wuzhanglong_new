...
public class MyRedMoneyUsedFragment extends BaseFragment implements OnLoadMoreListener, ScrollableHelper.ScrollableContainer {
    ...
    public static MyRedMoneyUsedFragment newInstance() {
        MyRedMoneyUsedFragment fragment = new MyRedMoneyUsedFragment();
        return fragment;
    }
