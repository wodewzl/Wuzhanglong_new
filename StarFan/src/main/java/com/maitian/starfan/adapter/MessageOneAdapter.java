 ...
 */
public class MessageOneAdapter extends RecyclerBaseAdapter {
    public MessageOneAdapter(RecyclerView recyclerView) {
        super(recyclerView, R.layout.message_one_adapter);
    }
