 ...
 */
public class PaurseDetailAdapter extends RecyclerBaseAdapter {
    public PaurseDetailAdapter(RecyclerView recyclerView) {
        super(recyclerView, R.layout.paruse_prop_adapter);
    }
...
//        }
    ...
    public int getItemViewType(int position) {
        return R.layout.paruse_prop_adapter;
    }
}
