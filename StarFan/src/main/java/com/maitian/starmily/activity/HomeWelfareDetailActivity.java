...
public class HomeWelfareDetailActivity extends BaseActivity  implements BGAOnRVItemClickListener, SwipeRefreshLayout.OnRefreshListener, OnLoadMoreListener {
    ...
    public void baseSetContentView() {
        contentInflateView(R.layout.home_welfare_detail_activity);
    }
