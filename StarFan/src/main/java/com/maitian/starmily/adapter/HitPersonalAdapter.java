 ...
 */
public class HitPersonalAdapter extends RecyclerBaseAdapter {
    public HitPersonalAdapter(RecyclerView recyclerView) {
        super(recyclerView, R.layout.hit_persional_adapter);
    }
...
//        }
    ...
    public int getItemViewType(int position) {
        return R.layout.hit_persional_adapter;
    }
}
