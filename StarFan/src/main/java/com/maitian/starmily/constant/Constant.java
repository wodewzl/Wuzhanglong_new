...
public class Constant {
    ...
    public static final String TOPIC_DETAILS = "topic/topicDetails/"; //帖子详情
    public static final String FAVORIATE_TOPIC = "topic/favoriateTopic/"; //收藏
    ...
    public static final String FAVORIATE_NEWS = "news/favoriateNews/"; //资讯收藏
    public static final String FIND_REPLY_BY_PAGE = "news/findReplyByPage/"; //资讯评论回复列表
